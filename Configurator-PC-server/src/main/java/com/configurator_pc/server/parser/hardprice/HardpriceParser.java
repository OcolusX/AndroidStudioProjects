...
public final class HardpriceParser extends Parser {
    ...
    public HardpriceParser() {
        super("C:\\Users\\melch\\AndroidStudioProjects\\Configurator-PC-server\\src\\main\\java\\com\\configurator_pc\\server\\parser\\hardprice\\hardpriceComponentTypes.json");
    }
    ...
    protected void parseList(int componentTypeId, String url) {
        try {
            ...
            for(Element element : elements) {
                ...
                ComponentParsingTask parsingTask = new HardpriceComponentParsingTask("https://hardprice.ru/" + href, 0, componentTypeId);
